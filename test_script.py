...
if __name__ == "__main__":
    ...
    defend = False
    pgd_params = {'norm': 'inf', 'eps': max_perturb, 'alpha': alpha, 'iterations': iterations, 'TI': False}
    deepfool_params = {"iters" : iterations, 'eps': max_perturb, 'TI': False}
    mifgsm_params = {'eps': max_perturb, 'steps': iterations, 'decay': 1.0, 'alpha': alpha}
    ...
    acc, _, norms = test(model, defend, 'Results_{}'.format(attack), max_perturb)
